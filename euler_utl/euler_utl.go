...
func P2(l *logging.Logger) (uint64, string, error) {

	pnum := 2
	l.Log(logging.Info, fmt.Sprintf("%s %d", "Start with Problem ", pnum))
	problem_text := `Each new term in the Fibonacci sequence is generated by adding the previous two terms. 
...
find the sum of the even-valued terms.`
	...
	return uint64(result), problem_text, nil
}
